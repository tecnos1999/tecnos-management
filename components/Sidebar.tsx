...
const menuItems = [
  { name: "Dashboard", icon: faTachometerAlt ,  color: "bg-blue-500"},
  { name: "Products", icon: faBoxOpen,  color: "bg-yellow-500"},
  { name: "Category", icon: faList , color:"bg-red-500" },
  { name: "SubCategory", icon: faTags , color: "bg-green-500"},
  { name: "Tags", icon: faTag , color: "bg-purple-500"}
];
